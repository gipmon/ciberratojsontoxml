...
#define  SUPER_MODEL_DOESNT_EXISTS		20
#define  INVALID_BEACON_HEIGHT			21
#define  THICKNESS_MODEL_ERROR			22
#define  NULL_MODEL_NAME				23
#define  INVALID_MODEL_HEIGHT			24
#define  INVALID_WALL_HEIGHT			25
#define  INVALID_WALL_THICKNESS			26
